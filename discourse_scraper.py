...
start_date = datetime(2025, 1, 1, tzinfo=timezone.utc) # THIS CAN BE MODIFIED FOR BONUS MARK 
end_date = datetime(2025, 4, 14, tzinfo=timezone.utc) # THIS CAN BE MODIFIED FOR BONUS MARK 
...
if __name__ == "__main__":
    try:
        ...
        data = []
        final_page = 20 # 0,1,2,3,4,5,6 - making this 20 for the bonus mark challenge.
